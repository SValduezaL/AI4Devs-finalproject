# Spec: Order Status Source

> **Origen**: [`cu03-b1-worker-db-sync`](../../changes/archive/2026-03-02-cu03-b1-worker-db-sync/)  
...
> **Nota de arquitectura**: Esta es la Opción C (solución temporal). La Opción B (`packages/prisma-db`), que introduce un workspace package neutro como fuente de verdad explícita, está documentada y pendiente en el ticket `infra-prisma-shared-schema`. Ver [ADR-008](../../memory-bank/architecture/008-prisma-schema-worker-opcion-c.md).
